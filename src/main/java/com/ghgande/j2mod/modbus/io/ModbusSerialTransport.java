...
public abstract class ModbusSerialTransport extends AbstractModbusTransport {
    ...
    public void writeMessage(ModbusMessage msg) throws ModbusIOException {
        ...
        bytesPerSec /= ((commPort.getNumDataBits() == 0 ? 8 : commPort.getNumDataBits()) + (commPort.getNumStopBits() == 0 ? 1 : commPort.getNumStopBits()) + (commPort.getParity() == SerialPort.NO_PARITY ? 0 : 1));
