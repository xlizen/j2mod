...
public class ModbusTCPSeverTransport extends AbstractModbusTransport {
    ...
    private TCPListenerConnection master;

    public ModbusTCPSeverTransport() {
        lastActivityTimestamp = System.nanoTime();
    }

    public ModbusTCPSeverTransport(Socket socket) throws IOException {
        lastActivityTimestamp = System.nanoTime();
        this.socket = socket;
        setSocket(socket);
    }
    ...
    public ModbusTransaction createTransaction() {
        return new ModbusTCPServerTransaction(master);
    }
     ...
     * @param master Master
     */
    public void setMaster(TCPListenerConnection master) {
        this.master = master;
    }
